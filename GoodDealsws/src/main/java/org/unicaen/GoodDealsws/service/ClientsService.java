...
/**
 * ClientsService class determine all the method needed to make operation 
 * on the clients entity in the DB
 * @author emad
 *
 */
public class ClientsService {
	...
	/**
	 * method to check if the client with specific username and password exist in the DB
